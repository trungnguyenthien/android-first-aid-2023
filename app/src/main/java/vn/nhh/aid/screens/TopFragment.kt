...
class TopFragment : BaseFragment() {
    ...
    private fun btnSoCuu(): AppCompatButton {
        return view?.findViewById<AppCompatButton>(R.id.btn_so_cuu)!!
    }

    private fun btnTinHieu(): AppCompatButton {
        return view?.findViewById<AppCompatButton>(R.id.btn_tin_hieu)!!
    }

    private fun btnKhoaHoc(): AppCompatButton {
        return view?.findViewById<AppCompatButton>(R.id.btn_khoa_hoc)!!
    }
